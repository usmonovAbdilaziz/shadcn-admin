...
import { type CharacterUser, type Convo } from './data/chat-types'
// Fake Data
import { conversations } from './data/convo.json'

export function Character() {
  const [search, setSearch] = useState('')
  const [selectedUser, setSelectedUser] = useState<CharacterUser | null>(null)
  const [mobileSelectedUser, setMobileSelectedUser] =
    useState<CharacterUser | null>(null)
